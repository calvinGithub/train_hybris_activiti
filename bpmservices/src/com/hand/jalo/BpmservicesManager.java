...
/**
 * This is the extension manager of the Bpmservices extension.
 */
public class BpmservicesManager extends GeneratedBpmservicesManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(BpmservicesManager.class);
	 ...
	 */
	public static BpmservicesManager getInstance()
	{
		return (BpmservicesManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(BpmservicesConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public BpmservicesManager() // NOPMD 
	{
		LOG.debug("constructor of BpmservicesManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of BpmservicesManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of BpmservicesManager called, current tenant: {}", getTenant().getTenantID());
	}
