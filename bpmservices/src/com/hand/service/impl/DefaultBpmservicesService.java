...
public class DefaultBpmservicesService implements BpmservicesService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultBpmservicesService.class);
	...
	{
		return DefaultBpmservicesService.class.getResourceAsStream("/bpmservices/sap-hybris-platform.png");
	}
