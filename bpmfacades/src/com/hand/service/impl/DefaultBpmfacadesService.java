...
public class DefaultBpmfacadesService implements BpmfacadesService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultBpmfacadesService.class);
	...
	{
		return DefaultBpmfacadesService.class.getResourceAsStream("/bpmfacades/sap-hybris-platform.png");
	}
