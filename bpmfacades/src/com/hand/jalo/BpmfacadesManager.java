...
/**
 * This is the extension manager of the Bpmfacades extension.
 */
public class BpmfacadesManager extends GeneratedBpmfacadesManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(BpmfacadesManager.class);
	 ...
	 */
	public static BpmfacadesManager getInstance()
	{
		return (BpmfacadesManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(BpmfacadesConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public BpmfacadesManager() // NOPMD 
	{
		LOG.debug("constructor of BpmfacadesManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of BpmfacadesManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of BpmfacadesManager called, current tenant: {}", getTenant().getTenantID());
	}
