...
import com.hand.constants.HepbaseConstants;
...
/**
 * This is the extension manager of the hepbase extension.
 */
public class HepbaseManager extends GeneratedHepbaseManager
{
	/**
	 * Edit the local|project.properties to change logging behavior (properties 'log4j.*').
	 */
	@SuppressWarnings("unused")
	private final static Logger LOG = Logger.getLogger(HepbaseManager.class.getName());
	 ...
	 */
	public static final HepbaseManager getInstance()
	{
		return (HepbaseManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(HepbaseConstants.EXTENSIONNAME);
	}
